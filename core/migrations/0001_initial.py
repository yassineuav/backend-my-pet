# Generated by Django 4.0.5 on 2022-08-01 04:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('likes', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.likes')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('views', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='views', to='core.views')),
            ],
        ),
        migrations.CreateModel(
            name='Address',
